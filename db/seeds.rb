...
100.times do
    gossips = Gossip.create!([{ title: Faker::Lorem.sentences, content: Faker::Lorem.sentences(number: 3), user_id: Faker::Number.between(from: 1, to: 100) }])
end

puts "Gossips created!"

100.times do
  tags = Tag.create!([{ title: Faker::Lorem.sentences }])
end
